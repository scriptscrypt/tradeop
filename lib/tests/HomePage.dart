...
class HomePage extends StatefulWidget {
  ...
  const HomePage({Key? key, required this.sheetName}) : super(key: key);
...
//Checks-if-there-is-any-change-in-the-widget
  ...
  Future fnGetSharedPrefs() async {
    ...
    print("SharedPref in HomePage is - ${sharedSignedInUser}");
    ...
    return ListView(
      children: [
        Row(
          ...
          children: [
            Text(textScaleFactor: 1.6, "Trading on").paddingOnly(right: 8.0),
            Container(
          ...
          children: [
            ...
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  backgroundColor: Color.fromRGBO(140, 158, 255, 1),
                  showCloseIcon: true,
                  closeIconColor: Colors.black87,
                  content: Center(
                    child: Text(
                      style: TextStyle(color: Colors.white),
                      'Please click on Wallet Tab',
                    ),
                  ),
                ));
              },
